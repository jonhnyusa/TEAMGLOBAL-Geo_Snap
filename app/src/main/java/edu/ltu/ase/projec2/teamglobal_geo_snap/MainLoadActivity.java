...
public class MainLoadActivity extends Activity
{
    ...
    private class LoadViewTask extends AsyncTask<Void, Integer, Void>
    {
        ...
        protected void onPreExecute()
        {
            ...
            viewSwitcher = new ViewSwitcher(MainLoadActivity.this);
	        /* Initialize the loading screen with data from the 'loadingscreen.xml' layout xml file.
	         * Add the initialized View to the viewSwitcher.*/
            viewSwitcher.addView(ViewSwitcher.inflate(MainLoadActivity.this, R.layout.loadingscreen, null));
        ...
        protected void onPostExecute(Void result)
        {
            ...
            Intent loginIntent = new Intent(MainLoadActivity.this,LoginSigninActivity.class);
            MainLoadActivity.this.startActivity(loginIntent);
            MainLoadActivity.this.finish();
			///* Initialize the application's main interface from the 'main.xml' layout xml file.
	        // * Add the initialized View to the viewSwitcher.*/
            //viewSwitcher.addView(ViewSwitcher.inflate(MainLoadActivity.this, R.layout.main, null));
            //Switch the Views
